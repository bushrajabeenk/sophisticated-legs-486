    ...
    {data.map((item) => (
      ...
      >
        <VStack w={'9rem'} lineHeight='15px'>
          <Text w='100%' fontSize='12px' fontWeight='bold'  color="red.400" p='2px' boxShadow='lg' textAlign="right" >
         ...
         color: 'green.400',
           ...
           />
          <Text fontSize='10px' textAlign='left'>Standard Delivery: Today 9:00AM - 11:00AM</Text>
          </HStack>
          <HStack>
            <InputGroup size='sm'>
